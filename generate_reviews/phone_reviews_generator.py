...
def generate_email(first_name, last_name):
    domains = ['gmail.com', 'yahoo.com', 'outlook.com', 'hotmail.com', 'outlook.com', 'hotmail.co.uk', 'msn.com', 'hotmail.fr', 'aol.com', 'yahoo.fr', 'yahoo.com.br', 'hotmail.it','googlemail.com', 'yahoo.es']
    joins = ['', '.', '_','-']
    ...
    if(random.randint(0, 1) == 1):
        username = username + ''.join(random.choices(string.digits, k=random.randint(1, 3)))
...
def generate_phone_number():
    ...
    patterns = ['+X-XXX-XXX-XXXX', '+XX XX XXXX XXXX', '+X.XXX.XXX.XXXX', '+X XXX XXX XXXX', '+X.XXX.XXX.XXXX', '+XXXXXXXXXXX', '+X (XXX) XXX-XXXX', '+X (XXX) XXX XXXX', '+X (XXX) XXX.XXXX','X-XXX-XXX-XXXX', 'X.XXX.XXX.XXXX', 'X XXX XXX XXXX', 'X.XXX.XXX.XXXX','X (XXX) XXX-XXXX', 'X (XXX) XXX XXXX', 'X (XXX) XXX.XXXX' ,'XXX-XXX-XXXX', 'XXX.XXX.XXXX', 'XXX XXX XXXX', 'XXX.XXX.XXXX', '(XXX) XXX-XXXX', '(XXX) XXX XXXX', '(XXX) XXX.XXXX', 'XXXXXXXXXX','XXX.XXXX' , 'XXX XXXX', 'XXX-XXXX', 'XXXXXXX', '1-XXX-XXX-XXXX', 'XXX-XXX-XXXX', 'XXX.XXX.XXXX', 'XXX XXX XXXX', '(XXX)XXX-XXXX', '(XXX)XXX.XXXX', '(XXX) XXX XXXX', '+X XXX XXX XXXX', '+X (XXX) XXX XXXX', '+XXXXXXXXXXX', 'XXXXXXXXXX', '(XXX) XXX-XXXX', '1-XXX-XXX-XXXX', '+1 XXX XXX XXXX']
...
# Define function to generate emails
def generate_email2():
...
first_names = ['jacob', 'olivia', 'ethan', 'emma', 'mia', 'noah', 'sophia', 'liam', 'ava', 'isabella', 'mason', 'jackson', 'amelia', 'hannah', 'emily', 'samantha', 'david', 'matthew', 'james', 'joseph', 'daniel', 'ashley', 'lauren', 'chloe', 'zoey', 'madison', 'andrew', 'ryan', 'william', 'benjamin', 'lucas', 'samuel', 'claire', 'lily', 'abigail', 'juliana', 'nathan', 'christopher', 'alexander', 'evan', 'brandon', 'tyler', 'joshua', 'emma', 'sofia', 'lucas', 'bella', 'charlotte', 'amelie', 'thomas', 'josephine', 'mila', 'leah', 'sarah', 'sophie', 'maxime', 'antoine', 'marie', 'julie', 'pierre', 'elodie', 'nicolas', 'clement', 'camille', 'louis', 'lucas', 'thomas', 'jules', 'hugo', 'romain', 'antoine', 'adrien', 'mathieu', 'claire', 'jean', 'marc', 'pauline', 'maurice', 'paul', 'jacques', 'albert', 'arthur', 'laura', 'beatrix', 'jonas', 'jhonny', 'bethany', 'stella', 'prilla', 'caroline', 'carol', 'maria', 'roxanne', 'anna', 'anne', 'max']

last_names = ['smith', 'johnson', 'williams', 'jones', 'brown', 'davis', 'miller', 'wilson', 'moore', 'taylor', 'anderson', 'thomas', 'jackson', 'white', 'harris', 'martin', 'thompson', 'garcia', 'martinez', 'robinson', 'clark', 'rodriguez', 'lewis', 'lee', 'walker', 'hall', 'allen', 'young', 'king', 'wright', 'scott', 'green', 'baker', 'adams', 'nelson', 'carter', 'mitchell', 'perez', 'roberts', 'turner', 'phillips', 'campbell', 'parker', 'evans', 'edwards', 'collins', 'stewart', 'sanchez', 'morris', 'murphy', 'cook', 'rogers', 'peterson', 'cooper', 'reed', 'bailey', 'bell', 'gomez', 'kelly', 'howard', 'ward', 'cox', 'diaz', 'richardson', 'wood', 'watson', 'brooks', 'bennett', 'gray', 'james', 'reyes', 'cruz', 'hughes', 'price', 'myers', 'long', 'foster', 'sanders', 'ross', 'morales', 'powell', 'sullivan', 'russell', 'ortiz', 'jenkins', 'gutierrez', 'perry', 'butler', 'barnes', 'fisher']


# Define arrays of strings for different components of the product review
good_review_starts = ['absolutely love', ' absolutely loved',  "I'm really impressed with", "I'm very satisfied with", 'I strongly recommend', 'This is the best product.', 'I absolutely love','I absolutely loved', 'I highly recommend', 'I cannot live without', 'I am so happy with']
bad_review_starts = ["I'm not happy with", 'I was disappointed with', 'I regret buying', 'I hate', 'I do not recommend']
product_names = ['this phone', ' this tablet', 'this laptop', 'this smartwatch', 'these headphones', 'the iPhone', 'the Samsung Galaxy', 'the Sony Xperia', 'the Google Pixel', 'the OnePlus', 'the Xiaomi', 'the Huawei', 'the Motorola', 'the Macbook pro', 'the Asus Zenbook', 'the dell computer', 'the Microsoft computer']
product_features = ['the screen resolution', 'the battery life', 'the camera quality', 'the design', 'the sound quality', 'the camera', 'the battery life', 'the design', 'the performance', 'the display', 'the user interface', 'the build quality', 'the sound quality']
...
#     "price"
# ]
positive_adjectives = ['great', 'amazing', 'excellent', 'fantastic', 'superb', 'outstanding', 'phenomenal']
negative_adjectives = ['terrible', 'awful', 'poor', 'disappointing', 'bad', 'mediocre', 'unsatisfactory']
good_review_ends = ['definitely worth the price', 'an amazing product!', 'I would buy it again in a heartbeat', 'i would buy it again', 'i would definitely buy it again', 'exceeded my expectations', 'perfect in every way'' I couldn\'t be happier', 'it exceeded my expectations', 'I\'m very happy with my purchase', 'it\'s exactly what I was looking for']
bad_review_ends = ['a complete waste of money', 'do not buy this product', 'I wish I could return it', 'disappointing and frustrating', 'not worth the price','and I\'m very disappointed', ' it\'s not worth the money', ' I regret buying it', 'I expected more', 'it has too many issues']
connectors = ['is', 'seems to be']
phone_number_openings = ['text me at', 'call me at', 'give me a call at', 'my phone number is', 'you can reach me at']
email_openings = ['send me an email at', 'you can email me at', 'reach me by email at', 'my email is', 'email me at']
phone_number_openings = ['text me at', 'call me at', 'give me a call at', 'my phone number is', 'you can reach me at']
email_openings = ['send me an email at', 'you can email me at', 'reach me by email at', 'my email is', 'email me at']
greetings = ["hello", "hi", "hey there", "what's up", "greetings", "good day"]
before_name_connectors = ["I'm", "my name is", "I am"]
address_openings = ["i live in", "my address is", "I live at", "my home address is", "my shipping address is", "I am located at"]
...
with open("product_reviews7.csv", "w", newline="") as f:
    ...
    for i in range(2000):
        ...
        if option == 0:
            ...
            write_into_csv_opening(f"{review_start.capitalize()} {product_name}. {product_feature.capitalize()} {connector} {feature_adjective}. {phone_number_opening.capitalize()} ", writer, 'O')
        ...
        # elif option == 1:
        #      review = f"{review_start} {product_name} {connector} {product_feature} {feature_adjective}. {review_end}. {phone_number_opening} {phone_number} and {email_opening} {email}"
        # elif option == 2:
        #     review = f"{review_start} {product_name} {connector} {product_feature} {feature_adjective}. {email_opening} {email} and {phone_number_opening} {phone_number} . {review_end}"
        elif option == 1:
            ...
            write_into_csv_opening(f"{review_start} {product_name}, {product_feature} {connector} {feature_adjective}. {phone_number_opening.capitalize()} ", writer, 'O')
            write_into_csv_no_split(phone_number, writer, "PHO")
            write_into_csv(f" {and_or} {email_opening} ", writer, 'O')
            write_into_csv_no_split(email, writer, "EMAIL")
            ...
            write_into_csv_opening(f"{review_start.capitalize()} {product_name}, {product_feature} {connector} {feature_adjective}. {phone_number_opening.capitalize()} ", writer, 'O')
            write_into_csv_no_split(phone_number, writer, "PHO")
            write_into_csv(f" {and_or} {email_opening} ", writer, 'O')
            write_into_csv_no_split(email, writer, "EMAIL")
            write_into_csv(f". {before_name.capitalize()} ", writer, 'O')
            ...
            write_into_csv_opening(f"{review_start.capitalize()} {product_name}, {product_feature} {connector} {feature_adjective}", writer, 'O')
            ...
            if(random.randint(0, 1) == 1):
                ...
                write_into_csv_no_split(email, writer, "EMAIL")
            write_into_csv(f". {review_end.capitalize()}. {address_opening.capitalize()} ", writer, 'O')
            write_into_csv_no_split(address, writer, "ADDRESS")
            write_into_csv(f". ", writer, 'O')
            ...
            write_into_csv_opening(f"{greeting.capitalize()} {before_name} ", writer, 'O')
            write_into_csv_no_split(f"{first_name}", writer, "PER")
            write_into_csv(f". {review_start.capitalize()} {product_name} {product_feature} {connector} {feature_adjective}. {phone_number_opening.capitalize()} ", writer, 'O')
            write_into_csv_no_split(phone_number, writer, "PHO")
            ...
            write_into_csv_opening(f"{greeting.capitalize()} {before_name} ", writer, 'O')
            write_into_csv_no_split(f"{first_name}", writer, "PER")
            write_into_csv(f". {review_start.capitalize()} {product_name} {product_feature} {connector} {feature_adjective}. {email_opening.capitalize()} ", writer, 'O')
            write_into_csv_no_split(email, writer, "EMAIL")
            ...
            write_into_csv_opening(f"{greeting.capitalize()} {before_name} ", writer, 'O')
            write_into_csv(f"{first_name} {last_name}", writer, "PER")
            write_into_csv(f". {review_start.capitalize()} {product_name}, {product_feature} {connector} {feature_adjective}", writer, 'O')
            rand = random.randint(0, 1)
            if(rand == 1):
                write_into_csv(f". {phone_number_opening.capitalize()} ", writer, 'O')
                write_into_csv_no_split(phone_number, writer, "PHO")
        ...
        # else:
        #       review = f"{review_start} {product_name} {connector} {product_feature} {feature_adjective}. {phone_number_opening} {phone_number} and {email_opening} {email} {review_end}"
